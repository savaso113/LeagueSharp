...
namespace TheBrand.ComboSystem
{
    abstract class Skill : IComparable<Skill>
    {
        ...
        public virtual void Update(Orbwalking.OrbwalkingMode mode, IMainContext context, ComboProvider combo, Obj_AI_Hero target)
        {
        ...
        public abstract void Cast(Obj_AI_Hero target, bool force = false, HitChance minChance = HitChance.Low);
        public virtual void Combo(IMainContext context, ComboProvider combo, Obj_AI_Hero target)
        {
            Cast(target);
        }
        public virtual void LaneClear(IMainContext context, ComboProvider combo, Obj_AI_Hero target) { }
        public virtual void Harass(IMainContext context, ComboProvider combo, Obj_AI_Hero target)
        {
            Cast(target);
        }
        public virtual void Gapcloser(IMainContext context, ComboProvider combo, ActiveGapcloser gapcloser) { }
        public virtual void Interruptable(IMainContext context, ComboProvider combo, Obj_AI_Hero sender, ComboProvider.InterruptableSpell interruptableSpell) { }
