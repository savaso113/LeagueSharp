...
{
    public class KalistaTargetSelector
    {
        static KalistaTargetSelector()
        {
        ...
        public static TargetingMode Mode = TargetingMode.SmartKalista;
        private static Menu _configMenu;
        private static Obj_AI_Hero _selectedTargetObjAiHero;
        private static KalistaE _e;
        ...
        public static float GetPriority(Obj_AI_Hero hero)
        {
            ...
            if (hero.HasBuff("kalistacoopstrikemarkally")) return 2.5f;
        ...
        public static void AddToMenu(Menu config, KalistaE e)
        {
            _e = e;
            _configMenu = config;
            ...
            config.AddItem(
                new MenuItem("TargetingMode2", "Target Mode").SetShared()
            ...
            Vector3? rangeCheckFrom = null)
        {
            var t = GetTarget(ObjectManager.Player, spell.Range,
                (DamageType)spell.DamageType, ignoreShield, ignoredChamps, rangeCheckFrom);
