...
namespace TheKalista.Commons.ComboSystem
{
    public abstract class Skill : Spell, IComparable<Skill>
    {
        ...
        public bool ComboEnabled = true, LaneclearEnabled = true, HarassEnabled = true, LasthitEnabled; // If this skill should be used in Combo, ...
        /// <summary>
